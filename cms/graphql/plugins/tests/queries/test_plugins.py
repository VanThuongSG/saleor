...
def test_query_plugin_configurations(staff_api_client_can_manage_plugins, settings):
    ...
    # Enable test plugin
    settings.PLUGINS = ["cms.plugins.tests.sample_plugins.PluginSample"]
...
def test_query_plugin_configurations_for_channel_configurations(
    ...
    # Enable test plugin
    settings.PLUGINS = ["cms.plugins.tests.sample_plugins.ChannelPluginSample"]
...
def test_plugins_query_with_filter(
    ...
    settings.PLUGINS = [
        ...
        "cms.plugins.tests.sample_plugins.ActivePlugin",
