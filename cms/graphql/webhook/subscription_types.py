...
class AttributeBase(AbstractType):
    attribute = graphene.Field(
        "cms.graphql.attribute.types.Attribute",
...
class AttributeValueBase(AbstractType):
    attribute_value = graphene.Field(
        "cms.graphql.attribute.types.AttributeValue",
...
class CategoryBase(AbstractType):
    category = graphene.Field(
        "cms.graphql.product.types.Category",
...
class GiftCardBase(AbstractType):
    gift_card = graphene.Field(
        "cms.graphql.giftcard.types.GiftCard",
...
class ProductBase(AbstractType):
    product = graphene.Field(
        "cms.graphql.product.types.Product",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
    ...
    category = graphene.Field(
        "cms.graphql.product.types.products.Category",
...
class ProductVariantBase(AbstractType):
    product_variant = graphene.Field(
        "cms.graphql.product.types.ProductVariant",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class ProductVariantOutOfStock(ObjectType, ProductVariantBase):
    warehouse = graphene.Field(
        "cms.graphql.warehouse.types.Warehouse", description="Look up a warehouse."
    )
...
class SaleBase(AbstractType):
    sale = graphene.Field(
        "cms.graphql.discount.types.Sale",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class InvoiceBase(AbstractType):
    invoice = graphene.Field(
        "cms.graphql.invoice.types.Invoice",
...
class FulfillmentBase(AbstractType):
    fulfillment = graphene.Field(
        "cms.graphql.order.types.Fulfillment",
...
class CollectionBase(AbstractType):
    collection = graphene.Field(
        "cms.graphql.product.types.products.Collection",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class CheckoutBase(AbstractType):
    checkout = graphene.Field(
        "cms.graphql.checkout.types.Checkout",
...
class VoucherBase(AbstractType):
    voucher = graphene.Field(
        "cms.graphql.discount.types.Voucher",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class WarehouseBase(AbstractType):
    warehouse = graphene.Field(
        "cms.graphql.warehouse.types.Warehouse",
...
class PaymentBase(AbstractType):
    payment = graphene.Field(
        "cms.graphql.payment.types.Payment",
