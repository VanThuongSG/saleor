...
@patch("cms.account.notifications.default_token_generator.make_token")
@patch("cms.plugins.manager.PluginsManager.notify")
...
@patch("cms.account.notifications.account_delete_token_generator.make_token")
@patch("cms.plugins.manager.PluginsManager.notify")
...
@patch("cms.core.tasks.delete_from_storage_task.delay")
@freeze_time("2018-05-31 12:00:01")
...
@patch("cms.account.signals.delete_from_storage_task.delay")
@patch("cms.graphql.account.utils.account_events.customer_deleted_event")
...
@freeze_time("2018-05-31 12:00:01")
@patch("cms.plugins.webhook.plugin.get_webhooks_for_event")
@patch("cms.plugins.webhook.plugin.trigger_webhooks_async")
...
@freeze_time("2018-05-31 12:00:01")
@patch("cms.graphql.account.mutations.base.assign_user_gift_cards")
@patch("cms.graphql.account.mutations.base.match_orders_with_new_user")
...
@patch("cms.graphql.account.mutations.account.match_orders_with_new_user")
@patch("cms.graphql.account.mutations.account.assign_user_gift_cards")
