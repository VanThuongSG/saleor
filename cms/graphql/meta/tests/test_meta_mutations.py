...
@patch("cms.plugins.manager.PluginsManager.checkout_updated")
...
@patch("cms.plugins.manager.PluginsManager.product_updated")
...
def test_update_public_metadata_for_item_on_deleted_instance(api_client, checkout):
    ...
    with before_after.before(
        "cms.graphql.meta.mutations._save_instance", delete_checkout_object
    ):
        response = execute_update_public_metadata_for_item(
            api_client,
            None,
