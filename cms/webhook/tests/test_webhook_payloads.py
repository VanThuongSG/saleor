...
@freeze_time()
@mock.patch("cms.webhook.payloads.generate_order_lines_payload")
@mock.patch("cms.webhook.payloads.generate_fulfillment_lines_payload")
...
@mock.patch("cms.webhook.payloads._generate_order_lines_payload_for_tax_calculation")
...
@patch("cms.webhook.payloads.serialize_checkout_lines_for_tax_calculation")
@pytest.mark.parametrize("taxes_included", [True, False])
...
@patch("cms.order.calculations.fetch_order_prices_if_expired")
