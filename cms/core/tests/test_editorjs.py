...
@pytest.mark.parametrize(
    ...
    [
        ...
        'The Saleor Winter Sale is snowed <a href="https://docs.cms.io/docs/">',
        'The Saleor Sale is snowed <a href="https://docs.cms.io/docs/">. Test.',
        'The Saleor Winter Sale is snowed <a href="https://docs.cms.io/docs/">. '
        'Test <a href="https://docs.cms.io/docs/">.',
        "",
...
@mock.patch("cms.core.utils.editorjs.parse_url")
        ...
        "blocks": [
            {
                "data": {
                    ...
                    '<a href="https://docs.cms.io/docs/">. Test.'
                },
                "type": "paragraph",
            },
            {
