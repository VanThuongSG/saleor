...
def clean_permissions(
    required_permissions: List[str], cms_permissions: Iterable[Permission]
) -> List[Permission]:
    missing_permissions = []
    ...
    return [p for p in cms_permissions if p.codename in permissions]
