...
class OpenIDConnectPlugin(BasePlugin):
    ...
    CONFIG_STRUCTURE = {
        ...
        "use_oauth_scope_permissions": {
            ...
            "help_text": (
                ...
                "Saleor's permission scopes in format cms:<cms-perm>. Check"
    ...
    def _get_oauth_session(self):
        ...
        if self.config.use_scope_permissions:
            permissions = [f"cms:{perm}" for perm in get_permissions_codename()]
    ...
    def _use_scope_permissions(self, user, scope):
        ...
        if scope:
            ...
            user_permissions = get_cms_permission_names(permissions)
    ...
    def external_refresh(
        ...
        cms_refresh_token = jwt_decode(refresh_token)  # type: ignore
        token_endpoint = self.config.token_url
        try:
            token_data = self.oauth.refresh_token(
                token_endpoint,
                refresh_token=cms_refresh_token[OAUTH_TOKEN_REFRESH_FIELD],
            )
