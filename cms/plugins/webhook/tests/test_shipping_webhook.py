...
@mock.patch("cms.plugins.webhook.shipping.cache.set")
@mock.patch("cms.plugins.webhook.shipping.trigger_webhook_sync")
@mock.patch(
    "cms.plugins.webhook.plugin.generate_excluded_shipping_methods_for_order_payload"
)
...
@mock.patch(
    "cms.plugins.webhook.plugin.WebhookPlugin.excluded_shipping_methods_for_order"
)
...
@mock.patch(
    "cms.plugins.webhook.plugin.WebhookPlugin.excluded_shipping_methods_for_checkout"
)
...
@mock.patch(
    "cms.plugins.manager.PluginsManager.excluded_shipping_methods_for_checkout"
)
