...
@mock.patch("cms.plugins.webhook.tasks.send_webhook_request_sync")
...
@mock.patch("cms.plugins.webhook.tasks.create_delivery_for_subscription_sync_event")
@mock.patch("cms.plugins.webhook.tasks.send_webhook_request_sync")
...
@mock.patch("cms.plugins.webhook.tasks.observability.report_event_delivery_attempt")
@mock.patch("cms.plugins.webhook.tasks.requests.post")
...
@mock.patch("cms.plugins.webhook.tasks.observability.report_event_delivery_attempt")
@mock.patch("cms.plugins.webhook.tasks.requests.post")
@mock.patch("cms.plugins.webhook.tasks.clear_successful_delivery")
...
@mock.patch("cms.plugins.webhook.tasks.observability.report_event_delivery_attempt")
@mock.patch("cms.plugins.webhook.tasks.requests.post", side_effect=RequestException)
...
def test_send_webhook_request_sync_invalid_scheme(webhook, app):
    with pytest.raises(ValueError):
        target_url = "gcpubsub://cloud.google.com/projects/cms/topics/test"
...
@mock.patch("cms.plugins.webhook.tasks.send_webhook_request_sync")
@mock.patch("cms.plugins.webhook.plugin.generate_list_gateways_payload")
