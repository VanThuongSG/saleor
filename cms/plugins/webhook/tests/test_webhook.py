...
@mock.patch("cms.plugins.webhook.tasks.send_webhook_request_async.delay")
...
def test_create_event_payload_reference_with_error(
    ...
    monkeypatch.setattr(
        "cms.plugins.webhook.tasks.boto3.client",
...
@mock.patch("cms.plugins.webhook.plugin.send_webhook_request_async.delay")
...
@mock.patch("cms.plugins.webhook.tasks.send_webhook_using_scheme_method")
...
@mock.patch("cms.plugins.webhook.tasks.send_webhook_request_async.retry")
@mock.patch("cms.plugins.webhook.tasks.observability.report_event_delivery_attempt")
@mock.patch("cms.plugins.webhook.tasks.send_webhook_using_scheme_method")
