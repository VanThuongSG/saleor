...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_password_reset_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_account_confirmation_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_request_email_change_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_user_change_email_notification_task."
    "delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events."
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_set_user_password_email_task.delay"
)
...
@mock.patch("cms.plugins.user_email.notify_events.send_invoice_email_task.delay")
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_order_confirmation_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_fulfillment_confirmation_email_task."
    "delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_fulfillment_update_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_payment_confirmation_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_order_canceled_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_order_refund_email_task.delay"
)
...
@mock.patch(
    "cms.plugins.user_email.notify_events.send_order_confirmed_email_task.delay"
)
