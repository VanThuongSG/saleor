...
def setup_celery_logging(loglevel=None, **_kwargs):
    ...
    """
    logging.getLogger("cms.schedulers").setLevel(loglevel)
...
class PersistentScheduler(celery.beat.PersistentScheduler, BaseScheduler):
    ...
    Usage:
    $ celery --app cms.celeryconf:app beat \
        --scheduler cms.schedulers.schedulers.PersistentScheduler
    """
...
class DatabaseScheduler(BaseDatabaseScheduler, BaseScheduler):
    ...
    Usage:
    $ celery --app cms.celeryconf:app beat \
        --scheduler cms.schedulers.schedulers.DatabaseScheduler
    """
